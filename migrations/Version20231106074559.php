 ...
 */
final class Version20231106074559 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_annonce (category_id INT NOT NULL, annonce_id INT NOT NULL, INDEX IDX_318DD39B8805AB2F (annonce_id), INDEX IDX_318DD39B12469DE2 (category_id), PRIMARY KEY(category_id, annonce_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
