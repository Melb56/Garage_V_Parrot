 ...
 */
final class Version20231016100433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD utilisateur_id INT DEFAULT NULL, ADD equipement LONGTEXT NOT NULL, ADD `option` LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce DROP utilisateur_id, DROP equipement, DROP `option`');
    }
}
